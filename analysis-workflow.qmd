...
Graph 1 illustrates my proposed collaborative workflow that aims to meet the needs of teams of people with varied collaboration preferences and styles, while simultaneously elevating the quality and impact of the reports that I am responsible.

**Graph 1. Collaborating on high-quality data projects**
```{mermaid}
flowchart TD
    ...
    D1 --> |get feedback| F
    D2 -.-> E1[Github Pages*]
    E1 -.-> |utilize Github features| F[Revise]
    D3 --> |track changes| F
    F --> G[Publish]
```
